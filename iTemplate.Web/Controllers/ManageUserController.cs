...
namespace iTemplate.Web.Controllers
{
  ...
  public class ManageUserController : Controller
  {
    ...
    public ActionResult UserProfile(UserProfileModel profile, HttpPostedFileBase fileUpload)
    {
      ...
      if (fileUpload != null)
      {
        ...
        user.ProfilePhoto = new ImageInfo
        {
          Photo = new byte[fileLength],
          FileLength = fileLength,
          ContentType = fileUpload.ContentType
        };

        Stream fileStream = fileUpload.InputStream;
        fileStream.Read(user.ProfilePhoto.Photo, 0, fileLength);
      }
