...
namespace iTemplate.Library.Captcha
{
    public class Utility
    {
        public static byte[] GetCaptchaImage(string checkCode)
        {
        ...
        public static byte[] VerificationTextGenerator()
        {
            ...
            HttpContext.Current.Session["iTemplate.Captcha"] = randomCode;
